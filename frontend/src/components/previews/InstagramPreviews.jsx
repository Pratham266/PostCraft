...
const EllipsisSVG = () => (
  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
    ...
    <circle cx="5" cy="12" r="2" fill="#262626" />
    <circle cx="19" cy="12" r="2" fill="#262626" />
  </svg>
);
    ...
    <div className="w-[375px] bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3">
        <div className="flex items-center space-x-3">
          <InstagramLogoSVG />
          <span className="font-semibold text-sm text-black">instagram</span>
        </div>
    ...
    <div className="w-[375px] bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
      ...
      <div className="w-full relative">
        ...
        {images.length > 1 && (
          <>
            <button
              className="absolute left-2 top-1/2 transform -translate-y-1/2 hover:opacity-70 transition bg-white bg-opacity-70 rounded-full p-1"
              onClick={goPrev}
            ...
            <button
              className="absolute right-2 top-1/2 transform -translate-y-1/2 hover:opacity-70 transition bg-white bg-opacity-70 rounded-full p-1"
              onClick={goNext}
        ...
        <div className="absolute bottom-3 left-1/2 transform -translate-x-1/2 flex space-x-1">
          {images.map((_, idx) => (
            <button
              ...
              className={
                idx === current
                  ? 'w-2 h-2 bg-white rounded-full border border-gray-400'
                  : 'w-1.5 h-1.5 bg-white bg-opacity-50 rounded-full'
              }
              style={{ outline: 'none' }}
              onClick={() => goTo(idx)}
...
export const InstagramVideoPreview = ({ content }) => {
  ...
  return (
    <div className="w-[375px] bg-black border border-gray-200 rounded-lg shadow-sm overflow-hidden relative">
      {/* Header */}
      ...
      <div className="w-full relative bg-black" style={{ height: 500 }}>
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
            ...
            >
              <svg width="56" height="56" viewBox="0 0 56 56" fill="none">
                ...
                <rect x="18" y="16" width="6" height="24" rx="2" fill="#fff" />
                <rect x="32" y="16" width="6" height="24" rx="2" fill="#fff" />
              </svg>
            </button>
          </div>
        )}
        ...
        <div className="absolute right-3 top-1/2 transform -translate-y-1/2 flex flex-col space-y-4">
          <div className="flex flex-col items-center space-y-1">
            <button className="hover:opacity-70 transition">
              <VideoLikeSVG />
            </button>
            <span className="text-white text-xs font-semibold">17.3K</span>
          </div>
          <div className="flex flex-col items-center space-y-1">
            <button className="hover:opacity-70 transition">
              <VideoCommentSVG />
            </button>
            <span className="text-white text-xs font-semibold">1,126</span>
          </div>
          <div className="flex flex-col items-center space-y-1">
            <button className="hover:opacity-70 transition">
              <VideoShareSVG />
      ...
      <div className="px-4 py-3 bg-black">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-white text-sm">
            instagram • Original Kola laka velari
          </span>
        </div>
      </div>
    </div>
